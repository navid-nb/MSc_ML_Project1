...
def split_rolling_window(ins_dates, split_pct_rolling_train=0.6, split_pct_rolling_test=0.2, target_folds_count=10):
    """
    ...
    print(f"   Total validation observations: {actual_folds * ins_validation_window_size} (across {actual_folds} overlapping folds)")
    
    return ins_window_size, ins_training_window_size, ins_validation_window_size, step_size, actual_folds